 ...
 if ($tipo==2) { ?>
    ...
    <div id='cssmenu'>
        <ul>
            ...
            <li><?php echo $this->Html->link(__('Crear Exámenes'), array('controller' => 'examenes_cabeceras', 'action' => 'index')); ?></li>
            <li><?php echo $this->Html->link(__('Corregir Exámenes'), array('controller' => 'examenes_detalles', 'action' => 'index')); ?></li>
