<div class="contenidosTemarios index">
	...
	<tr>
		...
		<td><?php echo h($contenido['Contenido']['archivo_dir']); ?>&nbsp;</td>
		<td>
			<?php echo $this->Html->link($contenido['Usuario']['login'], array('controller' => 'usuarios', 'action' => 'view', $contenidos['Usuario']['id'])); ?>
		</td>
		<td><?php echo h($contenido['Contenido']['created']); ?>&nbsp;</td>
		<td><?php echo h($contenido['Contenido']['modified']); ?>&nbsp;</td>
		<td>
			<?php echo $this->Html->link($contenidos['Asignatura']['dsc'], array('controller' => 'asignaturas', 'action' => 'view', $contenidos['Asignatura']['id'])); ?>
		</td>
		<td class="actions">
			...
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $contenido['Contenido']['id']), null, __('Are you sure you want to delete # %s?', $contenidos['ContenidosTemario']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
