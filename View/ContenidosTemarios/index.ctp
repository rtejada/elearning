<div class="contenidosTemarios index">
	...
	<tr>
		...
		<td class="actions">
			...
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $contenidosTemario['ContenidosTemario']['id']), null, __('Are you sure you want to delete # %s?', $contenidosTemario['ContenidosTemario']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
